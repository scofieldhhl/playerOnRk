 ...
 */
public class CubeLeftOutBackAnimation extends Animation{
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        mCamera.save();
//        mCamera.translate(-(mWidth / 2 + mWidth / 2 * interpolatedTime), 0, 0);
		mCamera.translate(-(mWidth * 2 / 3 + mWidth * 1 / 3 * interpolatedTime), 0, 0);
